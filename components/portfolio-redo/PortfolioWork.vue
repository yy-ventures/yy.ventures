<template>
  <section class="portfolio-work-container">
    <div class="portfolio-work-header">
      <h2 class="headline_1">Invest</h2>
      <h2 class="headline_2">With Us</h2>
    </div>
    <div class="portfolio-work-body">
      <div class="content_left">
        <h4>
          Looking for an opportunity to invest in early stage Social Businesses?
        </h4>
      </div>
      <div class="content_right">
        <h4>
          To learn more about our investment approach and discuss scope of partnerships, please contact.
        </h4>
