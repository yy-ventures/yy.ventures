  ...
  <div class="east-africa-container">
    <div class="east-africa-header">
      <div class="header_content">
        <h2 class="highlight">Amarlab: Diagnostics at Your Doorstep</h2>
      </div>
    </div>
    <div class="east-africa-body">
      <div class="top-grid">
        <div class="top-grid-left">
          <h2>The pandemic was an opportunity in disguise for many</h2>
          <div class="sub-text">
        ...
        <div class="top-grid-right">
          <img
            src="~/assets/images/news/amarlab_2.jpg"
            alt=""
          />
        </div>
      </div>
      <div class="bottom-grid">
        ...
        <div class="bottom-grid-right">
          ...
          <p>Till date, they have ensured 5,000 recurring customers, and have received more than 12,000 test orders. They have demonstrated an impressive month-to-month growth rate of 140%. To be the first of its kind with nothing but organic approaches, Amarlab has become a reliable name. Amarlab is planning to expand their services across the country, and they have already onboarded 4 labs in Chittagong. They have been dealing with remote testing in collaboration with Dr. Lal Pathlabs, an India-based diagnostic centre that ensures high-end tests. Moreover, with the telemedicine partner Spreeha, serving the people of remote areas looks like a dream come true where Rohingya population may become great beneficiaries.</p>
        </div>
      </div>
    </div>
...
.east-africa-container {
  ...
  .east-africa-header {
    margin-top: 5%;
    height: 85vh;
    background-image: url("~/assets/images/news/amarlab_1.jpg");
